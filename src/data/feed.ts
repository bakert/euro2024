...
feed.nextMatches = upcomingMatches.filter((m: MatchT) => m.kickoff.getTime() === minKickoffDate);
...
feed.lastMatches = finishedMatches.filter((m: MatchT) => m.kickoff === maxKickoffDate);
